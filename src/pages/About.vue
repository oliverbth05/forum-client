            ...
            <div>
                ...
                <div class = 'flex-container-responsive m-t-3'>
                    ...
                    <div class = 'feature'>
                        ...
                        <h4 class = 'font-light'>User Authentication</h4>
                    </div>
                    
                    <div class = 'feature'>
                        <i class="fas fa-comments"></i>
                        <h4 class = 'font-light'>Feedback</h4>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          changeActiveFeature(num) {
              this.activeFeature = num
          }
        },
        created(){
