...
const actions = {
    ...
    fetchComments(context, post_id) {
        ...
        axios.get('http://localhost:3000/posts/' + post_id + '/comments')
        .then(response => {
    ...
    postComment(context, data) {
        context.commit('init_comments_loading')
        axios.post('http://localhost:3000/posts/' + data.post_id + '/comments', data)
        .then(response => {
    ...
    postReply(context, data) { //******FIX
        context.commit('init_comments_loading')
        axios.post('http://localhost:3000/posts/' + data.post_id + '/comments/' + data.comment_id + '/replies', data)
        .then(response => {
            context.commit('loadComments', response.data)
        })
    },
    ...
    deleteComment(context, data) {//******FIX
        context.commit('init_comments_loading');
        axios.delete('http://localhost:3000/posts/' + data.post_id + '/comments/' + data.comment_id)
        .then(response => {
    ...
    votePost(context, data) { 
        ...
        axios.put('http://localhost:3000/posts/' + data.post_id + '/votes', data)
        .then(response => {
    ...
    voteComment(context, data) {//******FIX
        context.commit('init_comments_loading')
        axios.put('http://localhost:3000/posts/' + data.post_id + '/comments/' + data.comment_id + '/votes', data)
        .then(response => {
            context.commit('loadComments', response.data)
        })
        .catch(err => {
